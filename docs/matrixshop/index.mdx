...
1. [开始使用](./quick-start)
2. [配置与系统](./configuration-structure)
3. [模块与机制](./modules-overview)
4. [更新日志](./release-notes)
5. [商店与模块详解](./shop-types)
...
6. [数据库与存储](./database-and-storage)
7. [模块总览](./modules-overview)
8. [商店与模块详解](./shop-types)
...
- [SystemShop 配置](./system-shop)
- [bStats 与遥测](./bstats-and-telemetry)

### 模块与机制

- [模块总览](./modules-overview)
- [PlayerShop、GlobalMarket、Auction](./player-economy-modules)
- [Menu、ChestShop、Transaction、Cart、Record](./interaction-modules)
